...
export const ProductFeatures: Record<ProductKey, string[]> = {
    ...
    "4g_portaball_portagoal_with_net": [
        `Truly portable football goal – patented spherical ball system moves omnidirectionally for quick set-ups and pitch-side repositioning.`,
        `Effortless lifting & lowering – double-pivot handle reduces strain for coaches and ground staff.`,
        `Elite build quality – 4G reinforced aluminium frame with zinc-plated internal joints for long-term durability.`,
        `Pitch-friendly – designed for both 3G/4G artificial and natural turf surfaces.`,
        `Clean pro finish – polyester powder coated white for a premium look and easier maintenance.`,
        `Set of 2 Complete goals including Net`,
        `4G aluminium goal frame (uprights, crossbar, sidebars and backbars)`,
        `102mm x 112mm reinforced aluminium`,
        `Net supports: 31.8mm diameter galvanised steel`,
        `2 x PortaBall units assembled to the side frame`,
        `2 x PortaBall units assembled to the backbars`,
        `White powder-coated finish`,
        `1 set = 2 x Goals, 8 x PortaBall units, 2 x tailored nets and all fixings`,
    ],
    "4g_uefa_portagoal": [],
    "4g_euro_portagoal": [],
