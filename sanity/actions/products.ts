...
import { filteredProductsQuery, productByIdQuery, productBySlugQuery, productsQuery } from "../queries/products";
...
export async function getFilteredProducts(filters: { category?: string; brand?: string; tag?: string }) {
